<?php
	...
	*/
	...
	$email_to = "contactus@iwantevents.co.uk"; 			// Specify the email address you want to send the mail to.
	$email_subject = "Event Enquiry Website"; 	// Set the subject of your email.
